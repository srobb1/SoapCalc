...
htfhp_additive_rowData = [
    ...
    {'section': "Trace Accelerants", 'Additive': 'Finished Soap (%TOW)', 'Value': 'Grate and melt with oils'},
    {'section': "Trace Accelerants", 'Additive': 'Eugenol (drops)', 'Value': 'Add drops to heated oil', 'Placeholder' : 'drops'},
    {"section": "Humectants and Hardeners", 'Additive': 'Sodium Lactate (%TOW)', 'Value': 'Add 30-60 sec after mixing oils/lye'},
    {'section': "Humectants and Hardeners", 'Additive': 'Sodium Chloride (%TOW)', 'Value': 'Dissolve in lye or add directly'},
    ...
    {'section': "Lather", 'Additive': 'Sorbitol (%TOW)', 'Value': 'Add to lye, trace, after cook, or colorants'},
    {'section': "Lather", 'Additive': 'Cetyl Alcohol (%TOW)', 'Value': None},
    {'section': "Lather", 'Additive': 'Citric Acid (%TOW)', 'Value': None},
    {'section': "Lather", 'Additive': 'Honey (%TOW)', 'Value': 'Heat-sensitive - add room temp or after cook'},
    {"section": "Fluid Enhancer", 'Additive': 'Yogurt (%TOW)', 'Value': 'Add room temperature or slightly warmed'},
    {"section": "Fluid Enhancer", 'Additive': 'Milk - Dairy or Plant (%TOW)', 'Value': 'Add room temperature or slightly warmed'},
    {"section": "Fluid Enhancer", 'Additive': 'Buttermilk (%TOW)', 'Value': 'Add room temperature or warmed'},
    {"section": "Fluid Enhancer", 'Additive': 'Heavy Cream (%TOW)', 'Value': 'Add room temperature or warmed'},
    {"section": "Fluid Enhancer", 'Additive': 'Goat Milk (%TOW)', 'Value': 'Add after cook - heat sensitive'},
    {"section": "Fluid Enhancer", 'Additive': 'Almond Milk (%TOW)', 'Value': 'Add room temperature or warmed'},
    {"section": "Fluid Enhancer", 'Additive': 'Coconut Yogurt (%TOW)', 'Value': 'Add room temperature or warmed'},
    {"section": "Fluid Enhancer", 'Additive': 'Juice or Fruit Puree (%TOW)', 'Value': 'WARM before adding to HTHP'},
    {"section": "Fluid Enhancer", 'Additive': 'Tofu (%TOW)', 'Value': 'Add room temperature'},
    {"section": "Soap Solvent", 'Additive': 'Glycerin (%TOW)', 'Value': 'NOT recommended for HP - use for colorant'},
    {"section": "Soap Solvent", 'Additive': 'Molasses (%TOW)', 'Value': 'Heat-sensitive - may cause caramelization'},
]
